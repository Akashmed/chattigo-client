                ...
                <form onSubmit={handleLogin} className="w-full max-w-md">
                    <img className="w-auto h-7 sm:h-8" src={image} alt=""/>
                        ...
                        <div className="mt-6">
                            ...
                            <button onClick={handleGglSignIn} className="flex w-full items-center justify-center px-6 py-3 mt-4 text-gray-600 transition-colors duration-300 transform border rounded-lg dark:border-gray-700 dark:text-gray-200 hover:bg-gray-50 dark:hover:bg-gray-600">
