...
Chattigo places a high priority on the security of each conversation. It can identify if a user is online. Messages are not stored in the database while both users are active; they are only saved when a user is offline. When the user comes back online, the messages are delivered and then deleted from the database.
