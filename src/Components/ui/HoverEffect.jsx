                ...
                >
                    ...
                    >
                        <AnimatePresence>
                            {hoveredIndex === idx && (
                                <motion.span
                                    className="absolute inset-0 h-full w-full bg-neutral-200 bg-gray-500/[0.8] block rounded-3xl"
...
export const CardTitle = ({ children }) => {
    return (
        <div className="flex items-center w-full p-4 bg-gray-700 rounded-lg shadow-lg">
